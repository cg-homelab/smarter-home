...
const features = [
  ...
  },
  {
    ...
    description: "Every home gets a unique write token. Your data stays yours.",
  },
  {
    icon: CheckCircle2,
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
          ...
          <TabsContent value="overview">
            ...
            <section className="flex flex-col items-center text-center gap-5 py-12">
              ...
              <p className="text-muted-foreground text-base sm:text-lg max-w-xl">
                Smarter Home turns raw power readings into clear, actionable
                insights — so you can cut waste, lower bills, and live more
                sustainably.
              </p>
            ...
            <section className="mt-6 rounded-xl border bg-muted/50 px-8 py-10 text-center flex flex-col items-center gap-4">
              <h2 className="text-xl font-bold">Ready to get smarter?</h2>
              <p className="text-sm text-muted-foreground max-w-md">
                Create a free account in seconds and start monitoring your first
                home today.
              </p>
              <Button size="lg" asChild>
            ...
            <div className="flex flex-col gap-6 max-w-2xl mx-auto">
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  An open-source energy monitoring and analytics platform built
              ...
              <Card>
                ...
                <CardContent className="text-sm text-muted-foreground leading-relaxed">
                  Smarter Home is a self-hosted system for tracking and
                  analysing energy usage across your properties. It collects
                  power readings from your devices, stores them in a time-series
                  database, and presents them in an easy-to-understand dashboard
                  — giving you full visibility into your consumption habits
      ...
      <footer className="border-t border-border py-6 text-center text-xs text-muted-foreground">
        © {new Date().getFullYear()} Smarter Home — open-source, self-hosted
      </footer>
    </div>
  );
}
